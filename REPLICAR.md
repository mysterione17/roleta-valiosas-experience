...
| `GTM_ID` | ID do Google Tag Manager do cliente, ex: `'GTM-XXXXXXX'` |
...
- Gira a roleta as 3 vezes, confirma que sempre fica valendo o prêmio de maior `rank` sorteado.
- Clica em "Garantir minha vaga" e confirma que cai no link de checkout certo, com UTMs da URL preservados.
